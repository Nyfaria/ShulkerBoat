package com.nyfaria.shulkerboat.network;
...
public class NetworkHandler {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(
            new ResourceLocation(NyfsShulkerBoat.MODID, "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void register() {
        List<BiConsumer<SimpleChannel, Integer>> packets = ImmutableList.<BiConsumer<SimpleChannel, Integer>>builder()
                .add((channel, id) -> SimpleEntityCapabilityStatusPacket.register(ExampleHolderAttacher.EXAMPLE_RL, ExampleHolderAttacher::getCustomHolderUnwrap, channel, id))
                .build();
